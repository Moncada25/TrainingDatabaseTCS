    ...
    protected static void createForeignKey() {
        ...
        try {
            ...
            if (Connect()) {
                ...
                statement = connection.createStatement();
                statement.execute("ALTER TABLE empleado ADD FOREIGN KEY(clave_depto) REFERENCES departamento (clave_depto)");
    ...
    protected static boolean insertDepartamento(Departamento departamento) {
        ...
        try {
            ...
            if (Connect()) {
                ...
                preparedStatement = connection.prepareStatement("INSERT INTO DEPARTAMENTO (clave_depto, nombre, presupuesto) VALUES (?,?,?)");
    ...
    protected static boolean insertEmpleado(Empleado empleado) {
        ...
        try {
            ...
            if (Connect()) {
                ...
                preparedStatement = connection.prepareStatement("INSERT INTO EMPLEADO (clave_empleado, nombre, apellidos, clave_depto) VALUES (?,?,?,?)");
        ...
        try {
            ...
            if (Connect()) {
                ...
                if (data.isEmpty()) {
                    ...
                    for (Object[] datum : data) modelo.addRow(datum);
